	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		...
		<div class="form-group">
			<input class="form-control {{ $errors->has('postcode') ? 'is-invalid' : '' }}"
				   ...
				   value="{{ !is_null($patient) && !is_null($patient->address) ? $patient->address->postcode : old('postcode') }}"
				   name="postcode"
	...
	<div class="col-lg-6 col-md-6 col-sm-12 open_address">
		...
		<div class="form-group">
			<input class="form-control"
				   ...
				   value="{{ !is_null($patient) && !is_null($patient->address) ? $patient->address->street : old('street') }}"
				   name="street" />
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-12 open_address">
		...
		<div class="form-group">
			<input class="form-control"
				   ...
				   value="{{ !is_null($patient) ? $patient->number_home : old('number_home') }}"
				   name="number_home" />
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-12 open_address">
		...
		<div class="form-group">
			<input class="form-control"
				   ...
				   value="{{ !is_null($patient) ? $patient->complement : old('complement') }}"
				   name="complement" />
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-12 open_address">
		...
		<div class="form-group">
			<input class="form-control"
				   ...
				   value="{{ !is_null($patient) && !is_null($patient->address) ? $patient->address->neighborhood : old('neighborhood') }}"
				   name="neighborhood" />
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-12 open_address">
		...
		<div class="form-group">
			<input class="form-control"
				   ...
				   value="{{ !is_null($patient) && !is_null($patient->address) ? $patient->address->city : old('city') }}"
				   name="city" />
		</div>
	</div>
	<div class="col-lg-6 col-md-6 col-sm-12 open_address">
		...
		<div class="form-group">
			<input class="form-control"
				   ...
				   value="{{ !is_null($patient) && !is_null($patient->address) ? $patient->address->uf : old('uf') }}"
				   name="uf" />
		</div>
	</div>
</div>
